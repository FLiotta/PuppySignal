...
def upgrade():
    ...
    op.add_column(
        "pet", sa.Column("specie_id", sa.Integer(), sa.ForeignKey("specie.id"))
    )

    # Code -> pet_id relationship
    op.add_column("code", sa.Column("pet_id", sa.Integer(), sa.ForeignKey("pet.id")))
    ...
    op.create_table(
        ...
        sa.Column("pet_id", sa.Integer(), sa.ForeignKey("pet.id"), nullable=False),
        sa.Column(
            "location_id", sa.Integer(), sa.ForeignKey("location.id"), nullable=False
        ),
        sa.Column("method", sa.String(50), nullable=False),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
