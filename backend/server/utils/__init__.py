...
def presign_url(boto3_client: S3Client, object_name: str, expiration: int = 3600) -> Optional[str]:
  try:
    ...
    logging.error(f"Failed to generate presigned-url for object {object_name} at bucket {settings.s3_bucket}: {e}")
    return None
